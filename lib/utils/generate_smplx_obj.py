...
if __name__ == '__main__':
    ...
    for phase in ['val']:
        ...
        split_path = 'data/THuman/split_{}.txt'.format(phase)
        # 'model_path' should be the root directory of SMPL-X directory.
        # e.g., model_path - smplx - SMPLX_NEUTRAL.pkl
        smplx_model_path = 'data/THuman/models'

        transform_root = 'data/THuman/{}/transform'.format(phase)

        # please set this to the root directory of the original THuman 2.0 smplx parameters
        param_root = 'data/THuman/THuman2.0_smplx'

        output_data_root = 'data/THuman/{}/smplx_obj'.format(phase)
